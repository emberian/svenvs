...
step happens iff Candle returns a kernel theorem.
  ...
  UNTRUSTED : Gemma (deliberately jailbroken). Proof does not care.
...
def ask_gemma(state_desc):
    ...
    adversary so the demo still runs (loud note). The model is UNTRUSTED."""
