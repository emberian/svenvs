...
The untrusted inhabitant does not merely *act* through the envelope (that is
...
is not a Python mirror, it is the verified prover, live, per proposal.
  ...
  UNTRUSTED : the inhabitant (jailbroken gemma-4-e2b, or --mock adversary).
...
# ===== the untrusted inhabitant: proposes allowlist CHANGES ==============
PROPOSE_DOC = (
